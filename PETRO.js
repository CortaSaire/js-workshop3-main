...
// const number = parseInt(prompt("შეიყვანეთ რიცხვი 1 -დან 100 -ის ჩათვლით:")); // კარგია ფუნქციებს, რომ სერჩავ (Number()-მეთოდი ან უბრალოდ თავში +-ც დაქასთვდა როგორც Numbers)


// // კარგია ამაზე არ მაქვს შენიშვნა
...
//     console.log("კენტია.");
//   }
// } else {// აქაც კარგია ასეთ შემთხვევებსაც, რომ ითვალისწინებ
...
// //ძალიან კარგია მომწონხარ, თითქმის ამიდგა
// switch (fruit) {
//   case "ვაშლი":
...
// let number;
// // ამან არ იმუშავა (როდესაც რიცხვის გარდა სხვა ნებისმირ რამეს შეიყვან უკვე იქრაშება)
// do {
...
// let max = 0; // ეს რა არ იმუშავებდა ? 

// // ეს ცოტა ნაწვალებ კოდს გავს და თან ჩათჯიბიტის ნაჩათლახარს ან კუკუშკა საიტებზე დასერჩილს მარა ნორმ )))
...
//ძალიან კარგია პეტრო და ასე გააგრძელე გთხოვ, რადგან ასეთ ლოგიკებზე არის აშენებული ყველა დიდი თუ საშვუალო აპლიკაცია 
//და მათ შორიც რეაქთიც რასაც სამომავლოდ ისწავლი ამაზე დგას
// (მადლობა დავალებისთვბის ძალიან კარგი იყო !!!!)